  ...
  <nav class="fixed -bottom-1 left-0 right-0 z-50">
    <div class="bg-slate-950/80 backdrop-blur-2xl border-t border-white/5 pb-safe">
      <div class="max-w-lg mx-auto flex justify-around items-center h-20 relative px-2">
        ...
        <NuxtLink to="/game/inicio" exact class="nav-link group" active-class="text-blue-500">
        ...
        <NuxtLink to="/game/stats" class="nav-link group" active-class="text-blue-500">
        ...
        <NuxtLink to="/game/lists/shelfs" class="nav-link group" active-class="text-blue-500">
