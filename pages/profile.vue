<template>
  <div class="p-6 max-w-lg mx-auto pb-24 min-h-screen" v-if="user">
    <header class="mb-10 mt-4">
      <h1 class="text-4xl font-black tracking-tight text-white italic uppercase">Perfil</h1>
    </header>
    ...
    <div v-else>
      ...
      <Transition name="fade-slide">
        <section v-if="isEditing" class="mt-8 space-y-4">
          <h3 class="text-blue-500 font-black uppercase tracking-[0.3em] text-xs mb-3 ml-2">Configuración</h3>
      ...
      <section class="mt-10" >
        <h3 class="text-blue-500 font-black uppercase tracking-[0.3em] text-xs mb-3 ml-2">Información de cuenta</h3>
